...
1. What is the DOM?
   ...
   Document Object Model. An HTML element tree that allows the content, structure, and style to be updated
...
3. What is an event listener?
   ...
   A method that is attached to an element to "listen" for actions taken on that element

4. Why would we convert a NodeList into an Array?

   So that array methods can be used on them

5. What is a component?

   Reusable custom-coded elements that can be used anywhere in your app
